...
public class HttpClientKeepSession {
	...
	public static void main(String[] args) {
		...
		System.out.println(new File("a.pdf").length());
		
	}
	
	public static void mainss(String[] args) throws Exception {
		// String surl =
		// "http://libgen.io/get.php?md5=65548EE3600CD9C66EDEF27EE9349326&key=5SE6PVHV2FHVQ8AX";
		...
		// 用户登陆
		CloseableHttpResponse response = HttpClientKeepSession
		...
		printCookies();
		response.close();
		CloseableHttpResponse xxxx = HttpClientKeepSession
				.get("http://libgen.io" + resourceUrl);
